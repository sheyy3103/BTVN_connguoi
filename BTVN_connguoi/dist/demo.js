class ConNguoi {
    constructor(ten, tuoi, gioi_tinh, dia_chi) {
        this.ten = ten;
        this.tuoi = tuoi;
...
class SinhVien extends ConNguoi {
    constructor(ten, tuoi, gioi_tinh, dia_chi, msv, diem_toan, diem_li, diem_hoa) {
...
class NhanVien extends ConNguoi {
    constructor(ten, tuoi, gioiTinh, diaChi, mnv, luong_co_ban, so_ngay_cong) {
